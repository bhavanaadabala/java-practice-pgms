...
public class Factorydemo
{
	public static void main(String[] args) 
	{
		...
		e.breath();
		e.animalinforest();*/
		aquaticanimalsfactory acf=new aquaticanimalsfactory();
		aquaticanimals af=acf.aquaticanimals("fish");
		af.lifespan();
		af.breath();
		af.animalinwater();
		System.out.println("\n");
		wildanimalsfactory wlf=new wildanimalsfactory();
		wildanimals wl=wlf.wildanimals("lion");
		wl.lifespan();
		wl.breath();
		wl.animalinforest();
